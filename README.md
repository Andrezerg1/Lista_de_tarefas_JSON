...
Este projeto foi desenvolvido com o objetivo de praticar conceitos fundamentais de programação e manipulação de arquivos em Python.
...
Tecnologias utilizadas:
 ...
 - OS module para manipulação do terminal
